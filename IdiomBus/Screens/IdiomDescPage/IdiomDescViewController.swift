...
class IdiomDescViewController: BaseViewController {
    ...
    private func setupView() {
        ...
        speechBtn.tintColor = UIColor(hex: 0x91434C)
...
extension IdiomDescViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let xyImageView = UIImageView(frame: CGRect(x: (screen_w - 220)/2, y: 0, width: 120, height: 30))
        xyImageView.center = sectionTitleLabel.center;
        xyImageView.contentMode = .scaleAspectFit
        xyImageView.tintColor = UIColor(hex: 0x91434C)
        xyImageView.image = UIImage(named: "xiangyun")
        idiomSectionHeaderView.addSubview(xyImageView)
        idiomSectionHeaderView.bringSubviewToFront(sectionTitleLabel);
