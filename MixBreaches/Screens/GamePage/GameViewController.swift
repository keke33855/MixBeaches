...
enum GameResult {
    ...
    var titleImage: UIImage? {
        switch self {
        case .fail:
            return UIImage(named: "YOULOSE!")
        case .win:
            return UIImage(named: "YOUWIN!")
        }
    }
}
class GameViewController: BaseViewController {
    ...
    @IBOutlet private weak var countDownLbl: CountdownLabel! {
        didSet {
            ...
            let fontSize: CGFloat = UIScreen.main.bounds.width == 320 ? 60 : 60
            countDownLbl.font = UIFont(name:"PLAYPULL", size:fontSize)
        }
    }
    var showOriginImage = false {
        didSet {
            ...
            _ = showOriginImage ? "Hide Photo" : "Show Photo"
        }
    }
